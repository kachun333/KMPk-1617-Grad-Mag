...
function CommitteeRegister() {
  ...
  const submitted = useSelector(state => state.firebase.profile.committee_registration);
  ...
  const handleSubmit = (submitObject) => {
    ...
    axios.post(
      "https://us-central1-ourpromise.cloudfunctions.net/api/committee/registration",
      submitObject,
